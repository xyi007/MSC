...
def evalrank(model_path, data_path=None, split='dev', fold5=False):
    ...
    vocab = deserialize_vocab('/home/xy/project/MSC/vocab/%s_vocab.json' % opt.data_name)
...
def t2i(images, captions, caplens, sims, npts=None, return_ranks=False):
    ...
    for index in range(npts):
        for i in range(5):
            ...
            #print('text_inds:', text_inds[0:10])
...
if __name__ == '__main__':
    evalrank(model_path="/home/xy/project/MSC/checkpoint/coco_SGR_64/model_best.pth.tar",
             data_path='/home/xy/project/MSC/data', split="testall", fold5=False) #mscoco1k: fold5=True, else: fold5=False
